...
declare class ApiRequest {
	 ...
	 * @returns A promise resolving to an ApiResponse or rejecting with an ApiError.
	 */
	protected fetchAndHandleResponse(
		target: URL,
		options: RequestInit,
		requestTimeout?: number,
	): Promise<ApiResponse>;
...
declare class CursorPaginatedResult<T>
	extends PaginatedResult<T>
	implements CursorPaginatedResult$1
{
...
> {
	...
	protected doCreateArray(
		body: object | object[] | null,
		params: Record<string, unknown>,
		resolveFn?: ResolveHandler<ElementType[]>,
	): Promise<ElementType[]>;
	/**
...
declare class Branches extends BaseCollection<Branch> {
	...
	): Promise<PaginatedResult$1<Branch>>;
	create(
...
declare class Comments extends BaseCollection<Comment> {
	...
	): Promise<PaginatedResult$1<Comment>>;
	create(
...
declare class Contributors extends BaseCollection<Contributor> {
	...
	list(
		request_params: ProjectWithPagination,
	): Promise<PaginatedResult$1<Contributor>>;
	create(
...
declare class GlossaryTerms extends BaseCollection<GlossaryTerm> {
	...
	): Promise<CursorPaginatedResult$1<GlossaryTerm>>;
	create(
...
type ListTranslationParams = ProjectWithPagination &
	CursorPagination & {
...
type KeyParamsWithPagination = ProjectWithPagination &
	CursorPagination & {
...
declare class Keys extends BaseCollection<Key> {
	...
	): Promise<CursorPaginatedResult$1<Key>>;
	create(
...
declare class Languages extends BaseCollection<Language> {
	...
	): Promise<PaginatedResult$1<Language>>;
	list(
		request_params: ProjectWithPagination,
	): Promise<PaginatedResult$1<Language>>;
	create(
...
declare class PaymentCards extends BaseCollection<PaymentCard> {
	...
	): Promise<PaginatedResult$1<PaymentCard>>;
...
declare class PermissionTemplate
	extends BaseModel
	implements PermissionTemplate$1
{
	id: number;
	role: string;
	permissions: string[];
...
declare class PermissionTemplates extends BaseCollection<PermissionTemplate> {
	...
	list(
		request_params: TeamOnly,
	): Promise<PaginatedResult$1<PermissionTemplate>>;
}
...
declare class QueuedProcesses extends BaseCollection<QueuedProcess> {
	...
	list(
		request_params: ProjectWithPagination,
	): Promise<PaginatedResult$1<QueuedProcess>>;
	get(
...
declare class Screenshots extends BaseCollection<Screenshot> {
	...
	list(
		request_params: ProjectWithPagination,
	): Promise<PaginatedResult$1<Screenshot>>;
	create(
...
declare class TranslationStatus
	extends BaseModel
	implements TranslationStatus$1
{
	status_id: number;
	title: string;
	color: string;
...
declare class Snapshots extends BaseCollection<Snapshot> {
	...
	list(
		request_params: ProjectWithPagination,
	): Promise<PaginatedResult$1<Snapshot>>;
	create(
...
declare class TeamUserBillingDetails$1
	extends BaseModel
	implements TeamUserBillingDetails$2
{
	billing_email: string;
	country_code: string;
	zip: string;
...
declare class TeamUsers extends BaseCollection<TeamUser> {
	...
	): Promise<PaginatedResult$1<TeamUser>>;
	get(
...
declare class TranslationProvider
	extends BaseModel
	implements TranslationProvider$1
{
	provider_id: number;
	name: string;
	slug: string;
...
declare class TranslationProviders extends BaseCollection<TranslationProvider> {
	...
	list(
		request_params: TeamWithPagination,
	): Promise<PaginatedResult$1<TranslationProvider>>;
	get(
...
declare class TranslationStatuses extends BaseCollection<TranslationStatus> {
	...
	list(
		request_params: ProjectWithPagination,
	): Promise<PaginatedResult$1<TranslationStatus>>;
	create(
...
declare class Translations extends BaseCollection<Translation> {
	...
	): Promise<CursorPaginatedResult$1<Translation>>;
	get(
...
declare class UserGroups extends BaseCollection<UserGroup> {
	...
	list(
		request_params: TeamWithPagination,
	): Promise<PaginatedResult$1<UserGroup>>;
	create(
...
declare class Webhooks extends BaseCollection<Webhook> {
	...
	list(
		request_params: ProjectWithPagination,
	): Promise<PaginatedResult$1<Webhook>>;
	create(
...
declare abstract class OtaCollection<
	ElementType,
	SecondaryType = ElementType,
...
declare class RefreshTokenResponse
	extends BaseModel
	implements RefreshTokenResponse$1
{
	access_token: string;
	scope: string;
	expires_in: string | number;
...
declare class RequestTokenResponse
	extends BaseModel
	implements RequestTokenResponse$1
{
	access_token: string;
	refresh_token: string;
	expires_in: string | number;
...
export {
	...
	type ClientData,
	type ClientParams,
	type Comment$1 as Comment,
	type CommentData,
	type CommentDeleted,
	type Contributor$1 as Contributor,
	type ContributorCreateData,
	type ContributorDeleted,
	type ContributorLanguages,
	type ContributorRights,
	...
	type CreateTranslationStatusParams,
	type CreateWebhookParams,
	type CursorPaginatedResult$1 as CursorPaginatedResult,
	type CursorPagination,
	type DownloadBundle,
	...
	type GlossaryTerm$1 as GlossaryTerm,
	type HttpMethod,
	type IApiError,
	type IAuthError,
	type Jwt$2 as Jwt,
	type Key$1 as Key,
	type KeyDeleted,
	type KeyParamsWithPagination,
	type KeyProjectPagination,
	type KeysBulkDeleted,
	type Language$1 as Language,
	type LanguageDeleted,
	type ListFileParams,
	type ListSegmentParams,
	type ListTaskParams,
	type ListTermsParams,
	type ListTranslationParams,
	LokaliseApi,
	LokaliseApiOAuth,
	LokaliseApiOta,
	LokaliseAuth,
	...
	type OtaBundleArchive$1 as OtaBundleArchive,
	type OtaBundleUpdateData,
	type OtaFramework,
	type OtaFreezePeriod$1 as OtaFreezePeriod,
	type OtaFreezePeriodParams,
	type OtaProjectFramework,
	type OtaRequestBundleParams,
	type OtaResourceDeleted,
	type OtaSdkToken$1 as OtaSdkToken,
	type OtaStatistics$1 as OtaStatistics,
	type OtaTeamProject,
	type OtaTeamProjectFramework,
	type OtaUsageParams,
	type PaginatedResult$1 as PaginatedResult,
	type PaginationParams,
	type PaymentCard$1 as PaymentCard,
	type Project$1 as Project,
	type ProjectAndKey,
	type ProjectDeleted,
	type ProjectEmptied,
	...
	type ProjectWithPagination,
	type QueuedProcess$1 as QueuedProcess,
	type QueuedProcessDetails,
	type RefreshTokenResponse$1 as RefreshTokenResponse,
	type RequestTokenResponse$1 as RequestTokenResponse,
	type Screenshot$1 as Screenshot,
	type ScreenshotData,
	type ScreenshotDeleted,
	type Segment$1 as Segment,
	type Snapshot$1 as Snapshot,
	type SnapshotDeleted,
	...
	type Team$1 as Team,
	type TeamOnly,
	type TeamUser$1 as TeamUser,
	type TeamUserBillingDetails$2 as TeamUserBillingDetails,
	type TeamUserDeleted,
	type TeamUserParams,
	type TeamWithPagination,
	type TermsDeleted,
	type Translation$1 as Translation,
	type TranslationData,
	type TranslationProvider$1 as TranslationProvider,
	type TranslationStatus$1 as TranslationStatus,
	type TranslationStatusColors,
	type TranslationStatusDeleted,
	type UpdateKeyData,
	...
	type UpdateLanguageParams,
	type UpdateProjectParams,
	type UpdateScreenshotParams,
	type UpdateSegmentBodyParams,
	type UpdateSegmentReqParams,
	...
	type UploadFileParams,
	type UploadedFileProcessDetails,
	type UserGroup$1 as UserGroup,
	type UserGroupDeleted,
	type UserGroupParams,
	type Webhook$1 as Webhook,
	type WebhookDeleted,
	type WebhookEventLangMap,
	type WebhookEvents,
	type WebhookProjectBranchAdded,
