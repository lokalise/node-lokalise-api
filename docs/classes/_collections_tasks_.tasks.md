...
*Defined in [collections/tasks.ts:7](https://github.com/lokalise/node-lokalise-api/blob/324e932/src/collections/tasks.ts#L7)*
...
*Defined in [collections/tasks.ts:6](https://github.com/lokalise/node-lokalise-api/blob/324e932/src/collections/tasks.ts#L6)*
...
*Defined in [collections/tasks.ts:5](https://github.com/lokalise/node-lokalise-api/blob/324e932/src/collections/tasks.ts#L5)*
