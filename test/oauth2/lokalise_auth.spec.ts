...
describe("LokaliseAuth", () => {
	...
	describe("constructor", () => {
		...
		it("is expected to throw an error if the client id is not provided", () => {
			expect(() => {
				new LokaliseAuth("", "fake");
			}).to.throw(Error);
		});

		it("is expected to set authData", () => {
	...
	describe("auth", () => {
		it("returns proper url with all set attrs", () => {
		...
		it("returns proper url with scope as string", () => {
